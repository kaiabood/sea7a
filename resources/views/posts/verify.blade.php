...
<div class="row justify-content-center">
  <div class="col-md-12">
      <div class="card">
          <div class="card-header"><h4>Verify The Posts</h4></div>
          ...
          <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                           ...
                           <form action="/post/verify/{{$post->id}}" method="POST">
                            {{ csrf_field() }}
                            

                          <td>  <button type="submit" class="btn btn-danger">ok</button></td>
                           </form>
